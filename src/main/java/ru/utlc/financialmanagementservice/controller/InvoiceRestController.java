...
//    public Mono<ResponseEntity<Response>> create(@RequestBody @Validated final InvoiceCreateUpdateDto dto,
//                                                 final BindingResult bindingResult) {
//        if (bindingResult.hasFieldErrors()) {
//            return Mono.just(handleValidationErrors(bindingResult));
//        }
//
